...
const zenApi = {
    stream: (model, context, options) => piAgentStream({ ...model, headers: zenApiHeaders(model, context, options) }, context, options),
    streamSimple: (model, context, options) => piAgentStreamSimple({ ...model, headers: zenApiHeaders(model, context, options) }, context, options),
};
